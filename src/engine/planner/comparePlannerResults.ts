...
export function comparePlannerResults(alphaResult: CalculationResult, shadow: MaterialPlannerShadowResult): PlannerComparisonResult {
  ...
  return {
    ...
    mode: shadow.mode === 'structured-material-v09160' ? 'legacy-alpha-vs-structured-v09160' : shadow.mode === 'structured-material-v0990' ? 'legacy-alpha-vs-structured-v0990' : shadow.mode === 'structured-material-v0980' ? 'legacy-alpha-vs-structured-v0980' : shadow.mode === 'structured-material-v0970' ? 'legacy-alpha-vs-structured-v0970' : 'alpha-vs-shadow-v0960',
