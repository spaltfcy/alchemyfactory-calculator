...
export type MaterialPlannerShadowResult = {
  ...
  mode: 'shadow-dag-v0960' | 'structured-material-v0970' | 'structured-material-v0980' | 'structured-material-v0990' | 'structured-material-v09150';
...
export type PlannerComparisonResult = {
  ...
  mode: 'alpha-vs-shadow-v0960' | 'legacy-alpha-vs-structured-v0970' | 'legacy-alpha-vs-structured-v0980' | 'legacy-alpha-vs-structured-v0990' | 'legacy-alpha-vs-structured-v09150';
...
export type StructuredMaterialPlan = MaterialPlannerShadowResult & {
  mode: 'structured-material-v0970' | 'structured-material-v0980' | 'structured-material-v0990' | 'structured-material-v09150';
...
export type LegacyAlphaComparisonArtifact = {
  enabled: boolean;
  mode: 'legacy-alpha-vs-structured-v0970' | 'legacy-alpha-vs-structured-v0980' | 'legacy-alpha-vs-structured-v0990' | 'legacy-alpha-vs-structured-v09150';
  comparison: PlannerComparisonResult;
