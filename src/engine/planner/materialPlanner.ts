...
export function runMaterialPlannerShadow(planModel: PlanModel, structuredBaseResult: CalculationResult): MaterialPlannerShadowResult {
  ...
  return {
    ...
    trace: [
      ...
      {
        phase: 'shadowResult',
        messageJa: 'structured plannerのmaterial summaryを生成します。旧比較solverはv0.9.24で削除済みです。',
...
export function solveStructuredMaterialPlan(planModel: PlanModel, structuredBaseResult: CalculationResult) {
  ...
  const structuredPlan = {
    ...
    acceptedResultEngine: 'structured-material-v09240',
    trace: [
      ...base.trace,
      {
      ...
      },
      {
        ...
        messageJa: 'StructuredBalanceSolverで生成したCalculationResultへcycleDecisionを反映して採用しています。旧比較solverはv0.9.24で削除済みです。',
        messageEn: 'The CalculationResult produced by StructuredBalanceSolver is accepted after applying cycle decisions. The retired comparison solver was removed in v0.9.24.',
